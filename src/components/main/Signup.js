...
class Signup extends Component {
  ...
  handleCodeVerification = () => {
    ...
    if (codeHasError) {
      ...
      verifyCode({ email: email, code: code }).then(
        function (result) {
          if (result.data.success) {
            this.createAccount();
          } else {
          ...
          {verificationSent ? (
            <div className={classes.contentContainer}>
              ...
              <div className={classes.verificationText}>
                ...
                <span className={classes.boldText}>{email}</span>.<br />
                <br />
                If you did not receive it in your main inbox, please check your
                junk folder.
              </div>
              ...
              >
                ...
                {termsError ? (
                  <FormHelperText className={classes.formHelperText} error>
                    You must agree to the terms of use and privacy policy to
                    proceed.
                  </FormHelperText>
                ) : (
                  <div />
